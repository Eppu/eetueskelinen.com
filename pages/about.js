        ...
        <div className="proj_body_container">
          <div className="row">
            <div className="col-xs-12">
              ...
              <h1 className="proj_title">About me</h1>
            </div>
          </div>
          <div className="row image_div">
            <img
              ...
              className="profile_img animate__animated fadeInUpSmall"
            ...
            <div className="col-md-10 col-xs-12">
              <div className="row">
                ...
                <div
                  ...
                  className="col-lg-6 col-md-6 col-sm-7 col-xs-12"
                >
                  <div className="row">
                    <div className="col-xs-0 col-md-1"></div>
                    <div
                      className="col-lg-12 wow animate__animated fadeInUpSmall"
                      id="about-text"
                    >
                      <h2>A little about me</h2>
                      <h4 className="wow animate__animated fadeInUpSmall">
                        I'm a designer and developer born and raised in the
                        freezing woods of Northern Finland, currently living in
                        Tampere.
                      </h4>
                      <p className="wow animate__animated fadeInUpSmall delay-50ms">
                        I'm driven by a fascination with bleeding-edge tech, and
                        intuitive, delightful design. The magic of using
                        something that <b>just works</b>.
                      </p>

                      <p className="wow animate__animated fadeInUpSmall delay-100ms">
                        I have skills and experiences spanning design and
                        engineering that allow me to take ideas from concept to
                        mock to prototype to, ultimately,{" "}
                        <b>functional end products</b>.
                      </p>

                      <p className="wow animate__animated fadeInUpSmall delay-250ms">
                        In my life as a human, I love making music 🎵, taking
                        photos with film cameras 📷 and{" "}
                        <i>
                          [insert designer bio staple like "artisan ____", or
                          meditation]
                        </i>
                        . Oh, and I also make some kickass pizza 🍕.
                      </p>
                      <p className="wow animate__animated fadeInUpSmall delay-500ms">
                        I love combining my design and technological backgrounds
                        in the role of a <b>UX engineer</b>.
                      </p>
                      <br />
                      <h2 className="wow animate__animated fadeInUpSmall">
                        Interests
                      </h2>
                      <div className="wow animate__animated fadeInUpSmall">
                        <p>
                          Currently, I’m particularly interested in{" "}
                          <b>interaction design</b>, immersion within the web
                          space and creative applications of technology in
                          social applications.
                        </p>
                        <p>
                      ...
                      <div className="wow animate__animated fadeInUpSmall">
                        <h2>Actual skills</h2>
                        <p>
                          <i>"Wait, so what does he actually do?"</i> <br />
                          <p>
                            Let me try to explain briefly, without paragraphs
                            upon paragraphs of self-gratuitous mumbo-jumbo.
                          </p>
                          <br />
                          <br />
                        </p>
                      ...
                      <p wow animate__animated fadeInUpSmall>
                        You can always reach me via my email,{" "}
                        <a href="mailto:hello@eetueskelinen.com">
                          hello@eetueskelinen.com
                        </a>
                        .
                        <br />
                        If you're a headhunter, shoot me an email instead of
                        calling, please.
                      </p>
                      <p wow animate__animated fadeInUpSmall>
                        ...
                        , as well as{" "}
                        <a target="_blank" href="https://instagram.com/eppu">
                          Instagram
                        </a>
                        .
                      </p>
